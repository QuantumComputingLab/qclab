%> @file HandleGate2.m
%> @brief Implements HandleGate2 class
% ==============================================================================
%> @class HandleGate2
%> @brief 2-qubit gate storing a handle to another 2-qubit gate.
%
%> 
...
classdef HandleGate2 < qclab.qgates.QGate2
  ...
  methods
    % Class constructor  =======================================================
    %> @brief Constructor for HandleGate2 objects
    %>
    %> Constructs a 2-qubit handle gate from the given gate handle `gate`
    %> and qubit offset `offset`. The default value of `offset` is 0.
    % ==========================================================================
    function [obj] = HandleGate2( gate, offset )
    ...
    function [qubits] = qubits(obj)
      qubits = obj.gate_.qubits + obj.offset_;
    end
    ...
    function [bool] = equals(obj, other)
      if isa(other, 'qclab.qgates.HandleGate2')
